...
export const SettingsPanel = memo(
  ({
    ...
    const handleUseAgentFileChange = useCallback(
    ...
    if (!selectedChat) {
      return (
        <Flex direction="column" height="100%" bg="gray.50" align="center" justify="center" p={8}>
          <VStack spacing={4}>
    ...
    if (isExpired) {
      return (
        <Flex direction="column" height="100%" bg="red.50" align="center" justify="center" p={8}>
          <Alert status="error" borderRadius="md" maxW="md">
            <AlertIcon />
            <Box>
              <AlertTitle>アプリケーションの有効期限が切れています</AlertTitle>
              <AlertDescription>最新版をダウンロードしてご利用ください。</AlertDescription>
            </Box>
          </Alert>
        </Flex>
      )
      ...
      <Flex direction="column" height="100%" bg="white">
            ...
            <VStack align="stretch" spacing={3}>
              ...
              <VStack align="stretch" spacing={2}>
                <HStack justify="space-between">
                  ...
                  <Button size="sm" variant="outline" onClick={handleShowApiKeySettings}>
                    設定
                  </Button>
                </HStack>
                ...
                {!isLoadingApiKey && (
                  <HStack>
                    ...
                    />
                    <Button size="sm" variant="ghost" onClick={handleToggleApiKeyVisibility}>
                      {showApiKey ? '隠す' : '表示'}
                    </Button>
                  </HStack>
                )}
        ...
        {tempFiles.length > 0 && (
          <Box borderTop="1px solid #ddd" bg="white">
            {/* @ts-ignore*/}
            <AttachmentList tempFiles={tempFiles} onDelete={onTempFileDelete} />
          </Box>
        )}
